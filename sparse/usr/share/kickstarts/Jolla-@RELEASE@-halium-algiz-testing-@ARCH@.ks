...
repo --name=adaptation-community-algiz-@RELEASE@ --baseurl=http://repo.sailfishos.org/obs/nemo:/testing:/hw:/volla:/halium-algiz:/@RELEASEMAJMIN@/sailfishos_@RELEASEMAJMIN@_@ARCH@/
repo --name=adaptation-community-halium13-@RELEASE@ --baseurl=http://repo.sailfishos.org/obs/nemo:/testing:/hw:/halium:/13:/@RELEASEMAJMIN@/sailfishos_@RELEASEMAJMIN@_@ARCH@/
